...
[
  {
    ...
    "valueValidators": [
      ...
      {
        "type": "REGEX",
        "args": ["^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89aAbB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$"],
...
injectScript(
  ...
  data.gtmOnSuccess,
  data.gtmOnFailure,
  'analyticsz-google-tag-manager-v1-2'
);
...
- name: Loads the AnalyticsZ GTM loader with a valid token
  code: |-
    ...
    assertThat(injectedUrl).isEqualTo('https://analyticsz.com/integrations/google-tag-manager/loader.js?token=123e4567-e89b-42d3-a456-426614174000');
    assertThat(cacheToken).isEqualTo('analyticsz-google-tag-manager-v1-2');
...
AnalyticsZ Google Tag Manager template version 1.2.0.
